...
vi.mock('~/export/encoder/webcodecs/encodeGraded', () => ({
  encodeGraded: (...args: unknown[]) => encodeGradedMock(...args),
}));

vi.mock('~/export/encoder/webcodecs/encodeDirect', async () => {
  const actual = await vi.importActual<
    typeof import('~/export/encoder/webcodecs/encodeDirect')
  >('~/export/encoder/webcodecs/encodeDirect');
  return {
    ...actual,
...
vi.mock('~/export/encoder/exportVideoSource', () => ({
...
vi.mock('~/export/encoder/webcodecs/streamFrameSource', () => ({
  createStreamFrameSource: (...args: unknown[]) =>
    createStreamFrameSourceMock(...args),
}));

vi.mock('~/export/encoder/webcodecs/grabFrameStream', () => ({
